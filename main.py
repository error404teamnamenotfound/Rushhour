...
if __name__ == '__main__':
    ...
    hybrid2 = Hybrid2(f'data/Rushhour9x9_6.csv', f'output/output9x9_6_hybrid2_test_35.csv')
    ...
    with open(f'output/output9x9_6_hybrid2_{len(moves_set)}.csv', 'w', newline='') as outputfile:
        fieldnames = ['car', 'move']
        writer = csv.writer(outputfile)
        writer.writerow(fieldnames)
        writer.writerows(moves_set)
    ...
    Visualize(f'data/Rushhour9x9_6.csv', f'output/output9x9_6_hybrid2_{len(moves_set)}.csv')
